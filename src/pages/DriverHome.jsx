...
export default function DriverHome() {
  ...
  function refresh() {
    api.pendingGroups().then(({ groups: next }) => setGroups(next)).catch((e) => setError('Ride updates unavailable: ' + e.message))
    api.myDriverRides().then(({ rides: next }) => setRides(next)).catch((e) => setError('Ride updates unavailable: ' + e.message))
  }
